...
class _HomeAppState extends State<HomeApp> {
  ...
  double num2 = 0.0;
  String operand = "";
  //Implement button functionality when user presses a certain key.
  ...
  //Style widget interaction using Material Design
  ...
  @override
  //Build Context for each Individual Button Pressed.
